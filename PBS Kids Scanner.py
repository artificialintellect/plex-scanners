...
def Scan(path, files, mediaList, subdirs, language=None, root=None):
  ...
  #file = open("/tmp/pbs-scanner.out", "a")
  #file.write("path=" + path + "\n")
  #file.write("len(files)=" + str(len(files)) + "\n")
  #file.write("len(mediaList)=" + str(len(mediaList)) + "\n")
  #file.write("len(subdirs)=" + str(len(subdirs)) + "\n")
  #file.write("subdirs[0]=" + str(subdirs[0]) + "\n")
  ...
  #file.write("len(paths)=" + str(len(paths)) + "\n")
  #file.write("len(paths[0])=" + str(len(paths[0])) + "\n")
